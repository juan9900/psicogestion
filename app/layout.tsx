...
export const metadata: Metadata = {
  ...
  description:
    "Psicóloga clínica en Maracaibo. Acompaño a adultos, adolescentes y niños en procesos de ansiedad, depresión y cambios de vida, de forma presencial y online. Agenda tu hora.",
  keywords: [
